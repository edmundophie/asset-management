 ...
 * generated in the asset package. 
...
public class ObjectFactory {
    ...
    private final static QName _NotifyAssetMaintenance_QNAME = new QName("http://service.informatika.org/", "notifyAssetMaintenance");
    ...
    private final static QName _NotifyAssetMaintenanceResponse_QNAME = new QName("http://service.informatika.org/", "notifyAssetMaintenanceResponse");
    private final static QName _SetAssetOwnerResponse_QNAME = new QName("http://service.informatika.org/", "setAssetOwnerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: asset
     * 
     */
    ...
    /**
     * Create an instance of {@link NotifyAssetMaintenance }
     * 
     */
    public NotifyAssetMaintenance createNotifyAssetMaintenance() {
        return new NotifyAssetMaintenance();
    }
    ...
    /**
     * Create an instance of {@link NotifyAssetMaintenanceResponse }
     * 
     */
    public NotifyAssetMaintenanceResponse createNotifyAssetMaintenanceResponse() {
        return new NotifyAssetMaintenanceResponse();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link NotifyAssetMaintenance }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.informatika.org/", name = "notifyAssetMaintenance")
    public JAXBElement<NotifyAssetMaintenance> createNotifyAssetMaintenance(NotifyAssetMaintenance value) {
        return new JAXBElement<NotifyAssetMaintenance>(_NotifyAssetMaintenance_QNAME, NotifyAssetMaintenance.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link NotifyAssetMaintenanceResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://service.informatika.org/", name = "notifyAssetMaintenanceResponse")
    public JAXBElement<NotifyAssetMaintenanceResponse> createNotifyAssetMaintenanceResponse(NotifyAssetMaintenanceResponse value) {
        return new JAXBElement<NotifyAssetMaintenanceResponse>(_NotifyAssetMaintenanceResponse_QNAME, NotifyAssetMaintenanceResponse.class, null, value);
    }
